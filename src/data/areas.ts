  ...
  interactables: [
    {
      ...
      y: 60,
      lines: [
        { speaker: 'narrator', text: 'A brass frame beside the door. Six stops, and a line notice pasted crooked at the bottom.' },
        { speaker: 'narrator', text: '"FERROW TUNNEL — NEUTRAL SECTION. Carriage lighting will be lost for 38–42 seconds. This is normal."' },
        { speaker: 'ori', emotion: 'neutral', text: 'Normal. Scheduled. Every single run.' },
        { speaker: 'ori', emotion: 'neutral', text: '(Anyone who rides this line knows exactly when the dark is coming, and exactly how long it lasts.)' },
      ],
    ...
    },
    {
      ...
      lockedLines: [{ speaker: 'narrator', text: 'An occupied seat. It would be rude to rummage before saying hello.' }],
      lines: [
        { speaker: 'narrator', text: 'A book bag, a folded blanket, and something white wedged behind the seat cushion.' },
        { speaker: 'narrator', text: 'A ticket stub. Seat 12. Serial 4416. Aldermere, window 2, 20:57.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Window two. Twenty fifty-seven.' },
        { speaker: 'ori', emotion: 'neutral', text: '(I have seen that window and that clock somewhere else tonight.)', punch: true },
      ],
    ...
    },
    {
      ...
      lines: [
        { speaker: 'narrator', text: 'She lets you look. Inside: sheet music, a rosin block worn to a saucer, and a children\'s book.' },
        { speaker: 'narrator', text: '"The Wandering Ren." Inside the cover, in pencil: for Nadia, from Gran.' },
        { speaker: 'ori', emotion: 'neutral', text: '(Ren. He walks out of every town before anyone can keep him.)', punch: true },
      ],
      effects: { evidence: ['book'] },
      exhaustedLines: [{ speaker: 'narrator', text: 'Rosin worn to a saucer. Somebody plays every single day.' }],
    },
    {
      id: 'dozers',
      ...
      lines: [
        { speaker: 'narrator', text: 'They surface reluctantly.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Did you notice the girl in seat twelve tonight?' },
        { speaker: 'narrator', text: '"Reading. Same as always. She was there at five to twelve — I remember, I checked my watch and envied her."' },
        { speaker: 'ori', emotion: 'neutral', text: '(23:55. Seat twelve. Confirmed by three people who have no reason to lie.)' },
      ],
    ...
    },
    {
      ...
      y: 60,
      lines: [
        { speaker: 'narrator', text: 'Hat boxes, a cello case, a birdcage with a very unimpressed budgerigar.' },
        { speaker: 'ori', emotion: 'neutral', text: 'No grey herringbone up here.' },
      ],
    },
    {
      id: 'window_p',
      ...
      y: 66,
      lines: [
        { speaker: 'narrator', text: 'Rain runs sideways across the glass. Beyond it, black fields and the occasional lit farmhouse.' },
  ...
  interactables: [
    {
      ...
      y: 96,
      lines: [
        { speaker: 'narrator', text: 'Behind the counter, tucked under a folded cloth: a biscuit tin heavy with coins.' },
        { speaker: 'narrator', text: 'Weighted on top of it, an opened letter. Cormery Culinary School. "...pleased to offer you a place..."' },
        { speaker: 'ori', emotion: 'neutral', text: '(Not railway money. Her own. Eleven months of it, by the look of the tin.)' },
    ...
    },
    {
      ...
      y: 96,
      lines: [
        { speaker: 'narrator', text: 'A steel spike bristling with the night\'s dockets. You thumb down to the last few.' },
        { speaker: 'narrator', text: 'One cocoa. 23:47. Initialled in a hurried hand: T.K.' },
    ...
    },
    {
      ...
      y: 96,
      lines: [
        { speaker: 'narrator', text: 'A bakelite radio with a cracked dial. The flex ends in a plug lying loose on the shelf.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Not plugged in. Not tonight, not for a long while.' },
      ],
    ...
    },
    {
      ...
      y: 130,
      lines: [
        { speaker: 'narrator', text: 'A scuff of pale powder on the boards, the size of a thumbprint. It smells faintly of pine.' },
    ...
    },
    {
      ...
      y: 90,
      lines: [
        { speaker: 'narrator', text: 'The glass is fogged from the galley. Someone drew a treble clef in it and half rubbed it out.' },
      ],
    },
  ],
...
const sleeper: Area = {
  ...
  interactables: [
    {
      id: 'comp4door',
      label: 'Compartment 4 door',
      x: 290,
      y: 126,
      r: 46,
      lines: [
        { speaker: 'narrator', text: 'The sliding door hangs open four centimetres and no further. Staff had to lever it.' },
        { speaker: 'narrator', text: 'The fold-down bunk ladder lies across the threshold, its top hook bent sideways.' },
        { speaker: 'narrator', text: 'In the floor track there is a fresh bright gouge. You lay the hook against it. It fits like a key.' },
        { speaker: 'ori', emotion: 'neutral', text: 'The lock never turned. Somebody wedged this door from the inside and let it slam onto the ladder.', punch: true },
        { speaker: 'ori', emotion: 'neutral', text: '(A locked room that was never locked. Just held.)' },
      ],
      effects: { evidence: ['ladder'], flags: ['know_jam'] },
      exhaustedLines: [{ speaker: 'narrator', text: 'The gouge in the track still matches the bent hook exactly.' }],
    },
    {
      id: 'comp4table',
      label: 'Compartment table',
      x: 356,
      y: 88,
      r: 72,
      lines: [
        { speaker: 'narrator', text: 'A folding table with a water glass, untouched, and a ticket stub squared neatly to the edge.' },
        { speaker: 'narrator', text: 'Compartment 4. A. Ren. Serial 4417. Aldermere, window 2, 20:58.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Paid in coin. Squared to the edge of the table like an exhibit.' },
      ],
    ...
    },
    {
      ...
      r: 72,
      lines: [
        { speaker: 'narrator', text: 'A walking cane lies under the bunk. Silver top, dark wood — and a raw sawn joint under the varnish.' },
        { speaker: 'narrator', text: 'It has been shortened by a good fifteen centimetres. The rubber tip still has its factory moulding lines.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Never once leaned on. This cane has never met a floor.' },
      ],
      effects: { evidence: ['cane'] },
      exhaustedLines: [{ speaker: 'narrator', text: 'A shortened cane with an unworn tip.' }],
    },
    {
      id: 'comp4window',
      label: 'Compartment window',
      x: 290,
      y: 62,
      r: 60,
      lines: [
    ...
    },
    {
      ...
      y: 170,
      lines: [
        { speaker: 'narrator', text: 'A mop bucket stands at the vestibule end with a card on the handle: MOPPED 23:40 — MIND THE FLOOR.' },
        { speaker: 'narrator', text: 'You put the back of your hand to the boards. Still cold. Still faintly damp.' },
        { speaker: 'narrator', text: 'Across the whole damp length of it: one pair of prints. Small. Narrow. Smooth soles.' },
        { speaker: 'ori', emotion: 'neutral', text: 'One pair. Not a single hobnailed boot print anywhere.', punch: true },
        { speaker: 'ori', emotion: 'neutral', text: '(Somebody who says he walked this corridor did not walk this corridor.)' },
      ],
      effects: { evidence: ['corridor'], flags: ['know_mop'] },
      exhaustedLines: [{ speaker: 'narrator', text: 'Still damp. Still one small pair of prints.' }],
    },
    {
      id: 'hamper',
      label: 'Linen hamper',
      ...
      y: 162,
      lines: [
        { speaker: 'narrator', text: 'A wicker hamper in the vestibule. Caught on the lid splinter: three grey herringbone fibres.' },
        { speaker: 'narrator', text: 'You dig. Under two sheets and a pillowslip, folded fast and badly: a grey herringbone coat.' },
        { speaker: 'narrator', text: 'Both shoulder seams have been taken in. The new thread is bright and the stitching is amateur.' },
        { speaker: 'ori', emotion: 'neutral', text: 'A big coat, cut down for a small person. Six metres from Compartment 4.', punch: true },
      ],
      effects: { evidence: ['coat'], flags: ['know_hamper'] },
      followUp: {
        requiresFlags: ['ev_coat'],
        lines: [
          { speaker: 'narrator', text: 'You turn the collar out under the corridor lamp. Pale powder is worked deep into the weave.' },
          { speaker: 'narrator', text: 'You rub it between finger and thumb. Sticky. Sharp. Pine.' },
          { speaker: 'ori', emotion: 'neutral', text: 'Rosin. The stuff you drag across violin strings.', punch: true },
        ],
    ...
    },
    {
      ...
      y: 136,
      lines: [
        { speaker: 'narrator', text: 'A chalk roster screwed to the vestibule wall.' },
        { speaker: 'narrator', text: 'OYELARAN — TUE NIGHT. OYELARAN — WED NIGHT.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Two nights back to back. That is a man running on fumes.' },
      ],
  ...
  interactables: [
    {
      ...
      y: 124,
      lines: [
        { speaker: 'narrator', text: 'A slim wooden crate stencilled KASS ARTIST MANAGEMENT — FRAGILE — INSTRUMENT.' },
        { speaker: 'narrator', text: 'The wax seal across the lid is cracked clean through, then pressed back down. Crooked. Still soft enough to dent.' },
        { speaker: 'ori', emotion: 'neutral', text: 'Broken and re-sealed within the hour. By somebody who owns the stamp.' },
      ],
    ...
    },
    {
      ...
      y: 100,
      lines: [
        { speaker: 'narrator', text: 'You get an arm down the back of the crate and your fingers close on something cold.' },
        { speaker: 'narrator', text: 'A silver cufflink. Engraved: T.K.' },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: 'ori', emotion: 'neutral', text: 'Somebody spent most of tonight in this corner. And it was not spent walking a corridor.' },
      ],
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: 'ori', emotion: 'neutral', text: '(If somebody wanted off this train and could not simply walk off it... that rule is a door.)', punch: true },
      ],
    ...
    },
    {
      ...
      y: 140,
      lines: [
        { speaker: 'narrator', text: 'Trunks, a bicycle, a crate of live chickens that would rather you did not.' },
